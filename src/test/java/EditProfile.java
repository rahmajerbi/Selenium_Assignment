...
class EditProfile extends PageBase{
    ...
    public String FillForm(){
        ...
        WebElement skills= waitAndReturnElement(skillsS);
        ...
        WebElement editproButton = this.waitAndReturnElement(EP);
        js.executeScript("arguments[0].scrollIntoView()",editproButton);
        
        editproButton.click();
        // explicit wait - to wait for the container to be click-able
        this.waitAndReturnElement(By.id("gender"));
        // Edi first name ONLY 
     ...
     public Logout logout(){
            ...
            this.waitAndReturnElement(By.xpath("//*[@id='user_navbar']/div/div[2]/div[2]/ul/li[7]/a")).click();
